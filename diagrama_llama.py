...
# Configuração da API
OPENROUTER_API_KEY = os.getenv("OPENROUTER_API_KEY") or "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"
...
def save_and_convert_diagram(plantuml_code: str):
    ...
    try:
        ...
        # Converter para PNG
        os.system("plantuml diagrama_classes_LLAMA.puml")
